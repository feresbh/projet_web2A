...
class produitC {
	function ajouterproduit($produit){
       ...
       /* $urlImage=$produit->getprix();
		...
		$sql="insert into produit (nom,idProduit,prix,quantite,couleur,urlImage,idCategorie) values ('$nom','$idProduit','$prix','$quantite','$couleur','$urlImage','$idCategorie')";
...
function afficherproduit ($produit){
	echo "nom: ".$produit->getnom()."<br>";
		...
		echo "urlImage: ".$produit->geturlImage()."<br>";
			echo "idCategorie: ".$produit->getidCategorie()."<br>";
	}
	...
	function modifierproduit($produit,$idProduit){
		$sql="UPDATE produit SET nom=:nom,idProduit=:iddProduit,prix=:prix,quantite=:quantite,couleur=:couleur,urlImage=:urlImage,idCategorie=:idCategorie WHERE idProduit=:idProduit";
...
try{		
        ...
        $urlImage=$produit->geturlImage();
            $idCategorie=$produit->getidCategorie();
		$datas = array(':nom'=>$nom,':iddProduit'=>$iddProduit,':prix'=>$prix,':quantite'=>$quantite,':couleur'=>$couleur,':urlImage'=>$urlImage,':idCategorie'=>$idCategorie);
		$req->bindValue(':nom',$nom);
