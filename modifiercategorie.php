...
if (isset($_GET['idProduitsCategorie'])){
    $produitcategorieC=new produitcategorieC();
    $result=$produitcategorieC->recupererproduitcategorie($_GET['idProduitsCategorie']);
    foreach($result as $row){
        $nom=$row['nom'];
        $idProduitsCategorie=$row['idProduitsCategorie'];
...
<tr>
<td>Id Produit</td>
<td><input type="text" name="idProduitsCategorie" value="<?PHP echo $idProduitsCategorie ?>"></td>
</tr>
<tr>
<td></td>
...
<tr>
<td></td>
<td><input type="hidden" name="idProduitsCategorie_ini" value="<?PHP echo $_GET['idProduitsCategorie'];?>"></td>
</tr>
</table>
</form>
<?PHP
...
if (isset($_POST['modifier'])){
    $produitcategorie=new produitcategorie($_POST['nom'],$_POST['idProduitsCategorie']);
    $produitcategorieC->modifierproduit($produitcategorie,$_POST['idProduitsCategorie_ini']);
