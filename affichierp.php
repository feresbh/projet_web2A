                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            ...
                                            <div id="submenu-1-2" class="collapse submenu" style="">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="blank-page.html">Ajouter Produit</a>
                                                    </li>
                                                    <li class="nav-item">
                                            ...
                                            foreach ($listeproduits as $row) {
                                               ...
                                               <!-- <th scope="row">1</th>-->
                                                ...
                                                <td><?PHP echo $row['couleur']; ?></td>
                                                 ...
                                                 <td><img src="<?PHP echo $row['urlImage'] ?>" width="100" height="40">
                                                    <!-- <img src="../back/images/Produits/<?php echo $pr->urlImage; ?>" alt="" class="pro-image-front">-->
                                                 </td>
