				...
				<div class="row">
					<div class="col-sm-3">
						<div class="shopper-info">
							...
							<a class="btn btn-primary" href="" name="">Get Quotes</a>
							<form method="POST" action="command.php">
								


							<button href="cart.php" class="btn btn-primary"   name="validercommande">Continue </button>
						</form>
					</form>
						</div>
					...
					<tbody>
						...
						foreach($panier as $row)
						{
						  ...
						  $chemin="images/produit".$id.".jpg"
							...
							<td class="cart_description">  <h4> <?PHP echo $row['nom']; ?></h4></td>

							<td class="cart_price"><p><?PHP echo $row['prix']; ?>DT</p></td>
						...
						<tr>
							...
							<td colspan="2">
								<table class="table table-condensed total-result">
									...
									<tr>
										<td>Total</td>
										<td><span><?php echo ($somme*1.18)." DT"; ?></span></td>
									</tr>
								</table>
							</td>
						</tr>
