                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/ajoutpromo.php">ajouter promotion</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/carousel.php">annuler promo</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/accordions.php">affichier la listte des promos</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/listgroup.php">Liste des clients fideles</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/typography.php">gerer la fidelisation</a>
                                        </li>
