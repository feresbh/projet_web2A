						...
						<tr >
							...
							<td class="cart_quantity">
								...
								<div class="cart_quantity_button">
									...
									<input class="cart_quantity_input" type="number" name="quantite" value="<?PHP echo $row['quantite']; ?>">
									<input type="hidden" value="<?PHP echo $row['id']; ?>" name="id"> 

									
								</div>
								<button name="Modifier" >update</button>
								 </form>
							</td>
							<td class="cart_delete">
							  <form method="POST" action="supprimerproduit.php">
        <button name="supprimer" ><i class="fa fa-times"></i></button>
        <input type="hidden" value="<?PHP echo $row['id']; ?>" name="id">  
  </form> 
							</td>
						</tr>
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							...
							<a class="btn btn-default check_out" href="command.php">Check Out</a>
					</div>
				</div>
			</div>
		</div>
