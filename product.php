...
{
if(isset($_POST['ajouterproduit1']) )	
{ 
 // $q1=$_POST['q1'];
  $q1=1;
  $id_display=$_GET["ida"];
...
{ 
  ...
  if($verif==0)
  {
    ...
    {
      echo "<script>alert(\"Le produit existe déja dans wishlist\")</script>";
    }
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									...
									<div class="productinfo text-center">
										...
										<a href="cart.php" class="btn btn-default add-to-cart" name="ajouterproduit1"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
											...
											<p><?PHP echo $row['nom']; ?></p>
											<input type="hidden" value="" name="id">
											<button href="cart.php" class="btn btn-default add-to-cart" name="ajouterproduit1"   >Add to cart</button>
